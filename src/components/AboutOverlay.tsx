      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl bg-[#0A0A0C]/80 border border-white/10 p-8 sm:p-10 rounded-3xl backdrop-blur-xl shadow-[0_0_40px_rgba(0,255,255,0.1)] overflow-hidden"
          >
            {/* Inner Glow Line */}
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-500">
              About Me
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {stats.map((stat, idx) => (
                <StatItem key={idx} label={stat.label} value={stat.value} suffix={stat.suffix} isVisible={isOpen} />
              ))}
            </div>
